...
const deriveMissingCoinPricesSinglePass = async ({
  ...
  if (canUsePriceOracle) {
    if (IS_DEV) {
      console.log("Missing coin price: using method 1 to derive price");
    }
  ...
  if (canUseSameCoinPriceInOtherPool) {
    if (IS_DEV) {
      console.log("Missing coin price: using method 2 to derive price");
    }
  ...
  if (canUseInternalPriceOracle) {
    if (IS_DEV) {
      console.log("Missing coin price: using method 3 to derive price");
    }
  ...
  if (canFetchMoreDataFromMainRegistry) {
    ...
    if (canUseSameCoinPriceInMainPool) {
      if (IS_DEV) {
        console.log("Missing coin price: using method 4 to derive price");
      }
