...
const configs = {
  ethereum: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x6523Ac15EC152Cb70a334230F6c5d62C5Bd963f1".toLowerCase(),
        "plain2basic",
      ],
      [
        "0x24D937143d3F5cF04c72bA112735151A8CAE2262".toLowerCase(),
        "plain2balances",
      ],
      ["0x6326DEbBAa15bCFE603d831e7D75f4fc10d9B43E".toLowerCase(), "plain2eth"],
      [
        "0x4A4d7868390EF5CaC51cDA262888f34bD3025C3F".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0x9B52F13DF69D79Ec5aAB6D1aCe3157d29B409cC3".toLowerCase(),
        "plain3basic",
      ],
      [
        "0x50b085f2e5958C4A87baf93A8AB79F6bec068494".toLowerCase(),
        "plain3balances",
      ],
      ["0x8c1aB78601c259E1B43F19816923609dC7d7de9B".toLowerCase(), "plain3eth"],
      [
        "0xE5F4b89E0A16578B3e0e7581327BDb4C712E44De".toLowerCase(),
        "plain3optimized",
      ],
      [
        "0x5Bd47eA4494e0F8DE6e3Ca10F1c05F55b72466B8".toLowerCase(),
        "plain4basic",
      ],
      [
        "0xd35B58386705CE75CE6d09842E38E9BE9CDe5bF6".toLowerCase(),
        "plain4balances",
      ],
      ["0x88855cdF2b0A8413D470B86952E726684de915be".toLowerCase(), "plain4eth"],
      [
        "0xaD4753D045D3Aed5C1a6606dFb6a7D7AD67C1Ad7".toLowerCase(),
        "plain4optimized",
      ],
      ["0x213be373FDff327658139C7df330817DAD2d5bBE".toLowerCase(), "metausd"],
      [
        "0x55aa9bf126bcabf0bdc17fa9e39ec9239e1ce7a9".toLowerCase(),
        "metausdbalances",
      ],
      ["0xC6A8466d128Fbfd34AdA64a9FFFce325D57C9a52".toLowerCase(), "metabtc"],
      [
        "0xc4C78b08fA0c3d0a312605634461A88184Ecd630".toLowerCase(),
        "metabtcbalances",
      ],
      [
        "0xECAaecd9d2193900b424774133B1f51ae0F29d9E".toLowerCase(),
        "metabtc-ren",
      ],
      [
        "0x40fd58d44cfe63e8517c9bb3ac98676838ea56a8".toLowerCase(),
        "metabtcbalances-ren",
      ],
    ...
    getFactoryCryptoRegistryAddress: async () =>
      "0xF18056Bbd320E96A48e3Fbf8bC061322531aac99",
    graphEndpoint:
      "https://api.thegraph.com/subgraphs/name/convex-community/volume-mainnet",
    fallbackGraphEndpoint:
  ...
  polygon: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x571FF5b7b346F706aa48d696a9a4a288e9Bb4091".toLowerCase(),
        "plain2basic",
      ],
      [
        "0x8925D9d9B4569D737a48499DeF3f67BaA5a144b9".toLowerCase(),
        "plain2balances",
      ],
      ["0xAe00f57663F4C85FC948B13963cd4627dAF01061".toLowerCase(), "plain2eth"],
      [
        "0x8101e6760130be2c8ace79643ab73500571b7162".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0x493084ca44c779af27a416ac1f71e3823bf21b53".toLowerCase(),
        "plain3basic",
      ],
      [
        "0x9b4ed6f8904e976146b3dc0233cd48cf81835240".toLowerCase(),
        "plain3balances",
      ],
      ["0xa9134fae98f92217f457918505375ae91fdc5e3c".toLowerCase(), "plain3eth"],
      [
        "0xcc9fd96c26c450dd4580893aff75efd5cb6c12fc".toLowerCase(),
        "plain3optimized",
      ],
      [
        "0x991b05d5316fa3a2c053f84658b84987cd5c9970".toLowerCase(),
        "plain4basic",
      ],
      [
        "0xC7c46488566b9ef9B981b87E328939CaA5ca152f".toLowerCase(),
        "plain4balances",
      ],
      ["0xf31bcdf0b9a5ecd7ab463eb905551fbc32e51856".toLowerCase(), "plain4eth"],
      [
        "0xAc273d5b4FC06625d8b1abA3BE8De15bDFb8E39f".toLowerCase(),
        "plain4optimized",
      ],
      ["0x4fb93D7d320E8A263F22f62C2059dFC2A8bCbC4c".toLowerCase(), "metausd"],
      [
        "0x39fE1824f98CD828050D7c51dA443E84121c7cf1".toLowerCase(),
        "metausdbalances",
      ],
      ["0xC05EB760A135d3D0c839f1141423002681157a17".toLowerCase(), "metabtc"],
      [
        "0xD8336532f6ED7b94282fAF724fe41d6145E07Cfc".toLowerCase(),
        "metabtcbalances",
      ],
    ]),
    ...
    graphEndpoint:
      "https://api.thegraph.com/subgraphs/name/convex-community/volume-matic-staging",
  },
  fantom: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x61E10659fe3aa93d036d099405224E4Ac24996d0".toLowerCase(),
        "plain2basic",
      ],
      [
        "0xd9Acb0BAeeD77C99305017821167674Cc7e82f7a".toLowerCase(),
        "plain2balances",
      ],
      ["0xE6358f6a45B502477e83CC1CDa759f540E4459ee".toLowerCase(), "plain2eth"],
      [
        "0xAD4768F408dD170e62E074188D81A29AE31B8Fd8".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0x3cABd83bCa606768939B843f91df8f4963dBC079".toLowerCase(),
        "plain3basic",
      ],
      [
        "0xD1602F68CC7C4c7B59D686243EA35a9C73B0c6a2".toLowerCase(),
        "plain3balances",
      ],
      ["0x5d58Eb45e97B43e471AF05cD2b11CeB4106E1b1a".toLowerCase(), "plain3eth"],
      [
        "0x7Ee25A34C921E4009B726cC6be0643fd6a39DbfE".toLowerCase(),
        "plain3optimized",
      ],
      [
        "0xABE216918fFDa43B44e3FC09639Fd82fD3527D89".toLowerCase(),
        "plain4basic",
      ],
      [
        "0x775A21E0dfE25aF30FF2FCAC37512EbD8fD36471".toLowerCase(),
        "plain4balances",
      ],
      ["0xb11Dc44A9f981fAF1669dca6DD40c3cc2554A2ce".toLowerCase(), "plain4eth"],
      [
        "0x9D7C28226AA7142cBF234ab9aa9C203D095c528B".toLowerCase(),
        "plain4optimized",
      ],
      ["0xfCE359115dFe1533a2458650123F86C454BC0213".toLowerCase(), "metausd"],
      [
        "0x09C62ad0694e3f1ad8cF8876aaBe56138C586f5F".toLowerCase(),
        "metausdbalances",
      ],
      ["0xC9438d8928486bD9621D326002F4672bF684187A".toLowerCase(), "metabtc"],
      [
        "0x2b70A5B878665FfDB4A06Ba40a264d6c70f68F4B".toLowerCase(),
        "metabtcbalances",
      ],
      [
        "0x210c806f6ae850279f7e298de749ec4b427d00dd".toLowerCase(),
        "metausd-geist",
      ],
      [
        "0xf82162bb68ad5a168345bb7efb2faa0edcca5177".toLowerCase(),
        "metausdbalances-geist",
      ],
    ]),
    BASE_POOL_LP_TO_GAUGE_LP_MAP: new Map([
      [
  ...
  arbitrum: {
    ...
    rpcUrl:
      "https://arb-mainnet.g.alchemy.com/v2/D5O-iVrTJhd_coUFfsPFrcX5RFaJ0LIa",
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x54e8A25d0Ac0E4945b697C80b8372445FEA17A62".toLowerCase(),
        "plain2basic",
      ],
      [
        "0xD68970e266cE1A015953897C7055a5E0bC657Af8".toLowerCase(),
        "plain2balances",
      ],
      ["0x7DA64233Fefb352f8F501B357c018158ED8aA455".toLowerCase(), "plain2eth"],
      [
        "0x0100fBf414071977B19fC38e6fc7c32FE444F5C9".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0xe381C25de995d62b453aF8B931aAc84fcCaa7A62".toLowerCase(),
        "plain3basic",
      ],
      [
        "0xc379bA7b8e1c6C48D64e1cf9dD602C97c9fD0F40".toLowerCase(),
        "plain3balances",
      ],
      ...
      [
        "0x8d53E5De033078367Ad91527c53abfd1Eb6bfa86".toLowerCase(),
        "plain4basic",
      ],
      [
        "0x2ac56cEBc2D27c9bB51a11773355E44371Eb88D3".toLowerCase(),
        "plain4balances",
      ],
      ["0x89287c32c2CAC1C76227F6d300B2DBbab6b75C08".toLowerCase(), "plain4eth"],
      [
        "0x06e3C4da96fd076b97b7ca3Ae23527314b6140dF".toLowerCase(),
        "plain4optimized",
      ],
      ["0x09672362833d8f703D5395ef3252D4Bfa51c15ca".toLowerCase(), "metausd"],
      [
        "0xBE175115BF33E12348ff77CcfEE4726866A0Fbd5".toLowerCase(),
        "metausdbalances",
      ],
      ["0x094d12e5b541784701FD8d65F11fc0598FBC6332".toLowerCase(), "metabtc"],
      [
        "0xF1f85a74AD6c64315F85af52d3d46bF715236ADc".toLowerCase(),
        "metabtcbalances",
      ],
    ]),
    BASE_POOL_LP_TO_GAUGE_LP_MAP: new Map([
    ...
    DISABLED_POOLS_ADDRESSES: [].map((a) => a.toLowerCase()),
    graphEndpoint:
      "https://api.thegraph.com/subgraphs/name/convex-community/volume-arbitrum-staging",
  },
  avalanche: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x697434ca761d4f86b553784b69f4f37f5edf54df".toLowerCase(),
        "plain2basic",
      ],
      [
      ...
      [
        "0x09672362833d8f703D5395ef3252D4Bfa51c15ca".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0x1de7f0866e2c4adAC7b457c58Cc25c8688CDa1f2".toLowerCase(),
        "plain3basic",
      ],
      [
        "0x094d12e5b541784701FD8d65F11fc0598FBC6332".toLowerCase(),
        "plain3balances",
      ],
      ["0xf1f85a74ad6c64315f85af52d3d46bf715236adc".toLowerCase(), "plain3eth"],
      [
        "0xaa82ca713d94bba7a89ceab55314f9effeddc78c".toLowerCase(),
        "plain3optimized",
      ],
      [
        "0x7544Fe3d184b6B55D6B36c3FCA1157eE0Ba30287".toLowerCase(),
        "plain4basic",
      ],
      [
        "0x7d86446ddb609ed0f5f8684acf30380a356b2b4c".toLowerCase(),
        "plain4balances",
      ],
      ["0x0eb0F1FaF5F509Ac53fA224477509EAD167cf410".toLowerCase(), "plain4eth"],
      [
        "0xCE94D3E5b0D80565D7B713A687b39a3Dc81780BA".toLowerCase(),
        "plain4optimized",
      ],
      ["0xa237034249290de2b07988ac64b96f22c0e76fe0".toLowerCase(), "metausd"],
      [
        "0xc50c05ca1f8c2346664bd0d4a1eb6ac1da38414f".toLowerCase(),
        "metausdbalances",
      ],
      ["0xa27f39E9C21b3376F43266E13Ad5A5d6E9BdB320".toLowerCase(), "metabtc"],
      [
        "0x505C34ED8dBE96d2D5C7D83158aA844887770970".toLowerCase(),
        "metabtcbalances",
      ],
    ]),
    BASE_POOL_LP_TO_GAUGE_LP_MAP: new Map([
  ...
  optimism: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0xC2b1DF84112619D190193E48148000e3990Bf627".toLowerCase(),
        "plain2basic",
      ],
      [
        "0x16a7DA911A4DD1d83F3fF066fE28F3C792C50d90".toLowerCase(),
        "plain2balances",
      ],
      ["0x4f3E8F405CF5aFC05D68142F3783bDfE13811522".toLowerCase(), "plain2eth"],
      [
        "0x0f9cb53Ebe405d49A0bbdBD291A65Ff571bC83e1".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0x78D0fC2B9D5AE65512DB242e424a9c683F18c243".toLowerCase(),
        "plain3basic",
      ],
      [
        "0x35796DAc54f144DFBAD1441Ec7C32313A7c29F39".toLowerCase(),
        "plain3balances",
      ],
      ["0x6600e98b71dabfD4A8Cac03b302B0189Adb86Afb".toLowerCase(), "plain3eth"],
      [
        "0x6D65b498cb23deAba52db31c93Da9BFFb340FB8F".toLowerCase(),
        "plain3optimized",
      ],
      [
      ...
      [
        "0xF6bDc2619FFDA72c537Cd9605e0A274Dc48cB1C9".toLowerCase(),
        "plain4balances",
      ],
      ...
      [
        "0xADf698e4d8Df08b3E2c79682891636eF00F6e205".toLowerCase(),
        "metausdbalances",
      ],
      // ['0xC6A8466d128Fbfd34AdA64a9FFFce325D57C9a52'.toLowerCase(), 'metabtc'],
    ...
    graphEndpoint:
      "https://api.thegraph.com/subgraphs/name/convex-community/volume-optimism-staging",
  },
  xdai: {
    ...
    getCryptoRegistryAddress: async () =>
      "0xF274A1D3a794E210d6AF9d77eb966f01FD9a646f",
    factoryImplementationAddressMap: new Map([
      [
      ...
      [
        "0xC9438d8928486bD9621D326002F4672bF684187A".toLowerCase(),
        "plain2balances",
      ],
      ["0x2b70A5B878665FfDB4A06Ba40a264d6c70f68F4B".toLowerCase(), "plain2eth"],
      [
        "0x2D036f0Ff6F440dB623e0D9D3B5Daa509e5500C3".toLowerCase(),
        "plain2optimized",
      ],
      [
        "0xec9cEBE650E181079576C1b6d0d2e092B1EdfF13".toLowerCase(),
        "plain3basic",
      ],
      [
        "0xe8269B33E47761f552E1a3070119560d5fa8bBD6".toLowerCase(),
        "plain3balances",
      ],
      ["0x114C4042B11a2b16F58Fe1BFe847589a122F678a".toLowerCase(), "plain3eth"],
      [
        "0x4244eB811D6e0Ef302326675207A95113dB4E1F8".toLowerCase(),
        "plain3optimized",
      ],
      [
        "0x66B5792ED50a2a7405Ea75C4B6B1913eF4E46661".toLowerCase(),
        "plain4basic",
      ],
      [
        "0xcB4eB43E31C830e22baF764c64F11F32C280496c".toLowerCase(),
        "plain4balances",
      ],
      ["0xc1C49622b63B961ce1D352ecb7D8261Ab5556695".toLowerCase(), "plain4eth"],
      [
        "0x0E2615ce69Cd3Dc3Ff6f66a975bEa0655F3bA7b9".toLowerCase(),
        "plain4optimized",
      ],
      ["0x4A5bF7Ab9A8202692051c19B102d3eDD62aaBAE6".toLowerCase(), "metausd"],
      [
        "0x0B4dc7A945695D11FD83e40B2DfC2B896A02395F".toLowerCase(),
        "metausdbalances",
      ],
      // ['0xC6A8466d128Fbfd34AdA64a9FFFce325D57C9a52'.toLowerCase(), 'metabtc'],
      // ['0xc4C78b08fA0c3d0a312605634461A88184Ecd630'.toLowerCase(), 'metabtcbalances'],
    ...
    graphEndpoint:
      "https://api.thegraph.com/subgraphs/name/convex-community/volume-xdai-staging",
  ...
  moonbeam: {
    ...
    factoryImplementationAddressMap: new Map([
      [
        "0x6842E0412AC1c00464dc48961330156a07268d14".toLowerCase(),
        "plain2basic",
      ],
      [
        "0x9fAe78C4bBB649deB7b2295dDB8A03adA7eB660F".toLowerCase(),
        "plain2balances",
      ],
      ...
      [
        "0xD19Baeadc667Cf2015e395f2B08668Ef120f41F5".toLowerCase(),
        "plain3basic",
      ],
      [
        "0x04e39EF8332e979Cf8e4f8891E64934FF65F231b".toLowerCase(),
      ...
      [
        "0x7Bb707085905c9D80854652809A1ba8480C11789".toLowerCase(),
        "plain4balances",
      ],
