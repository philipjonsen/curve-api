...
const { truncWithoutZeroDecimals, formatLargeNumber } = require("./Number.js");
...
describe("Number utils", () => {
  test("truncWithoutZeroDecimals()", () => {
    ...
    expect(truncWithoutZeroDecimals(BN(2.0), 0)).toBe("2");
    expect(truncWithoutZeroDecimals(BN(2.0))).toBe("2");
  });
