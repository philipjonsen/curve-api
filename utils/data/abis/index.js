...
import susdv2SCurveRewardsAbi from "./json/susdv2/sCurveRewards.json";
...
import musdSCurveRewardsAbi from "./json/musd/sCurveRewards.json";
import rsvSwapABI from "./json/rsv/swap.json";
import rsvSCurveRewardsAbi from "./json/rsv/sCurveRewards.json";
import tbtcSwapABI from "./json/tbtc/swap.json";
import tbtcSCurveRewardsAbi from "./json/tbtc/sCurveRewards.json";
import dusdSwapABI from "./json/dusd/swap.json";
import dusdSCurveRewardsAbi from "./json/dusd/sCurveRewards.json";
import pbtcSwapABI from "./json/pbtc/swap.json";
import pbtcSCurveRewardsAbi from "./json/pbtc/sCurveRewards.json";
import bbtcSwapABI from "./json/bbtc/swap.json";
import obtcSwapABI from "./json/obtc/swap.json";
import obtcSCurveRewardsAbi from "./json/obtc/sCurveRewards.json";
import sethSwapABI from "./json/seth/swap.json";
import eursSwapABI from "./json/eurs/swap.json";
import eursSCurveRewardsAbi from "./json/eurs/sCurveRewards.json";
...
import stethSCurveRewardsAbi from "./json/steth/sCurveRewards.json";
import saaveSwapABI from "./json/saave/swap.json";
import ankrethSwapABI from "./json/ankreth/swap.json";
import ankrethSCurveRewardsAbi from "./json/ankreth/sCurveRewards.json";
...
import balancerAbi from "./json/balancer.json";
